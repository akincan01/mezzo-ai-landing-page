...
const Roadmap = () => {
  ...
  return (
    <section id="roadmap" className="py-16 lg:py-24 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            <p className="text-xl text-muted-foreground font-manrope leading-relaxed">
              After Phase 1 (MVP launch), Mezzo AI will automatically handle sellers' operational workflows so they can focus entirely on sourcing great products — not on admin, uncertainty, or hours of busywork.
            </p>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-12">
          {automations.map((automation, index) => (
            <div 
              key={index}
              className="bg-card rounded-xl shadow-soft p-6 border border-border/50 hover:shadow-medium transition-smooth"
            >
